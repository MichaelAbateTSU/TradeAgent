...
The suite repeats every fold at baseline, 2x, and 3x commission and slippage. It computes
total and annualized return, annualized volatility, Sharpe, Sortino, Calmar, maximum
drawdown, turnover, positive-fold ratio, and relative results against an equal-risk
buy-and-hold benchmark.

## Current evidence

The following pipeline smoke test used 1,000 synthetic daily bars per seed and commit
`489536f`. Values shown are the baseline-cost scenario; all candidates also failed the
relative benchmark gate under 2x and 3x costs.

| Candidate | Seed | Positive folds | Average Sharpe | Folds beating benchmark | Average excess return | Qualified |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| SMA crossover | 7 | 54.5% | 1.125 | 36.4% | -0.0062% | No |
| SMA crossover | 17 | 63.6% | 1.166 | 18.2% | -0.0152% | No |
| SMA crossover | 29 | 81.8% | 2.776 | 27.3% | -0.0055% | No |
| Volatility trend | 7 | 54.5% | 1.034 | 27.3% | -0.0287% | No |
| Volatility trend | 17 | 63.6% | 1.078 | 18.2% | -0.0375% | No |
| Volatility trend | 29 | 72.7% | 2.861 | 27.3% | -0.0457% | No |
